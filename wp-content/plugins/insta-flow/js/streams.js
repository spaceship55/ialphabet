        ...
        <dl class="section-settings section-compact">\
                ...
                <dd>\
                    ...
                    <label for="stream-<%= id %>-date-order">Strictly by date</label><br><br>\
                        ...
                        <dt class="multiline">\
                            <span class="ff-icon-lock"></span>Show lightbox on card click\
                            <div class="desc hint-block">\
                                ...
                                <div class="hint hint-pro">\
                                    <h1>PREMIUM FEATURE</h1>\
                                        ...
                                        <a class="btn" href="https://goo.gl/AGDcLe" target="_blank">UPGRADE NOW</a>\
                                </div>\
                            </div>\
                        </dt>\
                        <dd>\
                            <label for="stream-<%= id %>-gallery"><input id="stream-<%= id %>-gallery" class="switcher" type="checkbox" name="stream-<%= id %>-gallery" disabled value="yep"/><div><div></div></div></label>\
                        </dd>\
...
<div class="design-step-1">\
    ...
    <div class="choose-wrapper">\
        ...
        <label for="stream-layout-masonry-<%= id %>">\
            <span class="choose-button"><i class="sprite-masonry"></i>Masonry</span><br>\
            <span class="desc">This Pinterest-style format will create grid where each card size depends on its content.</span>\
        </label>\
        ...
        <label class="inactive" for="stream-layout-grid-<%= id %>">\
            <div class="choose-button hint-block">\
                <span class="hint-link"><span class="ff-icon-lock"></span>Grid</span>\
        ...
        <label class="inactive" for="stream-layout-justified-<%= id %>">\
            <div class="choose-button hint-block">\
                <span class="hint-link"><span class="ff-icon-lock"></span>Justified</span>\
                <div class="hint hint-layout">\
                    <h1>PREMIUM FEATURE</h1>\
                    To get access to this and many other premium features please upgrade to PRO version.<br>\
                    <a class="btn" href="https://goo.gl/AGDcLe" target="_blank">UPGRADE NOW</a>\
            ...
            <span class="desc">Cards width is justified to have the same height. Content always overlays.</span>\
        </label>\
        <input name="stream-<%= id %>-layout" class="clearcache" id="stream-layout-carousel-<%= id %>" type="radio" value="carousel"/>\
        <label for="stream-layout-carousel-<%= id %>">\
            <span class="choose-button"><i class="sprite-carousel"></i>Carousel</span><br>\
            <span class="desc">Slide photos in beautiful carousel of posts. All cards are same size. Supports dragging.</span>\
        </label>\
        </div>\
    </div>\
    ...
    <dd>\
        ...
        <dd>\
            ...
            <dd>\
                ...
                <dt class="multiline carousel-hidden-field">\
                    <span class="ff-icon-lock"></span>Filters and search field\
                    <div class="desc hint-block">\
                        <span class="hint-link">Available in PRO</span>\
                        <div class="hint hint-pro">\
                            <h1>PREMIUM FEATURE</h1>\
                ...
                <dd class="carousel-hidden-field">\
                    <label for="stream-<%= id %>-filter"><input id="stream-<%= id %>-filter" class="switcher" type="checkbox" name="stream-<%= id %>-filter" disabled value="yep"/><div><div></div></div></label>\
                </dd>\
        ...
        <dd>\
            ...
            <dd>\
                ...
                <dd>\
                    ...
                    <dt class="multiline">\
                        <span class="ff-icon-lock"></span>Show User Profile\
                        <div class="desc hint-block">\
                            <span class="hint-link">Available in PRO</span>\
                            <div class="hint hint-pro">\
                                <h1>PREMIUM FEATURE</h1>\
                    ...
                    <dd>\
                        <label for="stream-<%= id %>-show-profile"><input class="switcher" type="checkbox" name="" disabled value=""/><div><div></div></div></label>\
                    </dd>\
                    </dl>\
...
<div class="width-wrapper"><div class="ff-table"><div class="ff-cell">\
    Grace — Instagram Feed Gallery Lite<br>\
    Version: <%= version %><br>\
...
<a href="https://twitter.com/looks_awesooome">LA Twitter</a><br>\
  ...
  <div class="feed-view" data-feed-type="instagram" data-uid="<%= uid %>">\
      ...
      <dl class="section-settings">\
          ...
          <input id="<%= uid %>-likes-type" data-cache-reset="true" type="radio" name="<%= uid %>-timeline-type" value="likes"/>\
...
<dd>\
<label for="<%= uid %>-mod"><input id="<%= uid %>-mod" class="switcher" type="checkbox" name="<%= uid %>-mod" disabled value="yep"/> <div><div></div></div></label>\
</dd>\
  </dl>\
...
filterView:     '\
         <div class="feed-view filter-feed" data-filter-uid="<%= uid %>">\
             ...
             <dl class="section-settings">\
                <dt class="">\
                    <span class="ff-icon-lock"></span>Include all\
                    <div class="desc hint-block">\
                        <span class="hint-link">Available in PRO</span>\
                        <div class="hint hint-pro">\
                            <h1>PREMIUM FEATURE</h1>\
             ...
             <div class="filter-hint hint-block">\

...
#ff-stream-<?php echo $id;?> .ff-filter-holder .ff-filter {
	border: 1px solid <?php echo $stream->filtercolor;?>;
}
#ff-stream-<?php echo $id;?> .selectric .button:before{
    border-top-color: <?php echo $stream->filtercolor;?>;
}
#ff-stream-<?php echo $id;?> .ff-stream-profile-header h3,
#ff-stream-<?php echo $id;?> .ff-stream-profile-meta,
#ff-stream-<?php echo $id;?> .ff-stream-profile-bio strong {
    color: <?php echo $stream->{'profile-text-color'};?>;
}
#ff-stream-<?php echo $id;?> .ff-stream-profile-bio {
    color: <?php echo $stream->{'profile-sec-color'};?>;
}
...
#ff-stream-<?php echo $id;?>-slideshow .ff-square:nth-child(1) {
...
#ff-stream-<?php echo $id;?> .ff-stream-profile{
    background-color: <?php echo $stream->{'profile-background-color'};?>;
}

#ff-stream-<?php echo $id;?> .ff-stream-profile-header a{
    background-color: <?php echo $stream->{'profile-button-base-color'};?>;
    color: <?php echo $stream->{'profile-button-label-color'};?>;
}
#ff-stream-<?php echo $id;?> .ff-stream-profile-bio a{
    color: <?php echo $stream->{'profile-button-base-color'};?>;
}
...
#ff-stream-<?php echo $id;?>-slideshow .ff-share-popup:after,
...
#ff-stream-<?php echo $id;?> .ff-filter:hover {
	color: <?php echo $stream->textcolor;?>;
	border: 1px solid <?php echo $stream->textcolor;?>;
}
